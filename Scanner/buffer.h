...
#define ERRINC 256			/* fail returns 256 */
...
#define MAX SHRT_MAX-1		/* checks for max value of buffer*/
#define MAXVALUEMULTI 100	/* Maximum value for MULTIPLICATIVE mode*/
#define AMAX 255			/*Maximum value for Additive mode*/
#define POSITIVE 1			/* Check positivity of variable */
#define TRUE 1				/* check for true condition */
/***************************************************************************************************************************************************
*TYPE DEFINATION
***************************************************************************************************************************************************/
